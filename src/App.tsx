...
import { exportarResultados, exportarCSVGrupo } from "./utils/exportarExcel";
    ...
    try {
      ...
      const gruposConNotas = gruposExtraidos.map((grupo) => ({
        ...
        estudiantes: grupo.estudiantes.map((est) => {
          ...
          return {
            ...est,
            notaPar: nota.nota_promedio !== null ? nota.nota_promedio : undefined,
        ...
        <div className="w-full">
              ...
              {menuExportAbierto && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 z-20 overflow-hidden">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 text-green-600 shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-gray-400">Todos los grupos</p>
                      </div>
                    </button>
                    ...
                    <div className="px-4 py-2">
                      <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">CSV por grupo</p>
                    </div>
                    ...
                    <div className="max-h-60 overflow-y-auto">
                      {cursoData.grupos.map((grupo) => (
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 text-blue-500 shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {gruposFiltrados.map((grupo) => {
              ...
              return (
                <div key={grupo.numero} className="bg-white rounded-xl shadow border border-gray-100 flex flex-col overflow-hidden">
                  <div
                  ...
                  >
                    ...
                    <h4 className="font-bold text-lg text-[#ce0019] flex-1">Grupo {grupo.numero}</h4>

                    {!editando && (
                      <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                        <label className="text-[10px] font-bold text-gray-500 uppercase whitespace-nowrap">Nota bruta</label>
                        <input
                            ...
                            >
                              ...
                              <td className="px-3 py-2.5 text-center">
                                {est.notaPar !== undefined ? (
                                  <span className="font-bold text-green-700 bg-green-50 px-2 py-0.5 rounded border border-green-100 text-xs">{est.notaPar}</span>
                                ) : (
                              ...
                              <td className="px-3 py-2.5 text-center">
                                {est.factorCastigoNoEvaluo !== undefined ? (
                                  <span className={`text-xs font-semibold px-2 py-0.5 rounded ${est.factorCastigoNoEvaluo > 0 ? "text-orange-700 bg-orange-50 border border-orange-100" : "text-gray-300"}`}>
                              ...
                              <td className="px-3 py-2.5 text-center">
                                {est.factorCastigoFueraGrupo !== undefined ? (
                                  <span className={`text-xs font-semibold px-2 py-0.5 rounded ${est.factorCastigoFueraGrupo > 0 ? "text-red-700 bg-red-50 border border-red-100" : "text-gray-300"}`}>
                              ...
                              <td className="px-3 py-2.5 text-center">
                                {est.notaConDescuento !== undefined ? (
                                  <span className="font-bold text-white bg-[#ce0019] px-2.5 py-0.5 rounded text-xs shadow-sm">{est.notaConDescuento}</span>
                                ) : (
                                  <span className="text-gray-300 text-xs">—</span>
                                )}
                              </td>
