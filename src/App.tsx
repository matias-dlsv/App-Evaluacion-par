          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="mt-4 relative">
              <button
                ...
                className="self-start px-3 py-1.5 bg-transparent font-medium rounded transition cursor-pointer text-white text-sm border border-white flex items-center gap-1.5"
                onMouseOver={(e) =>
              ...
              {mostrarMenu && (
                <>
                  ...
                  {/* Menu Items */}
                  <div
                    className="absolute top-full left-0 mt-2 bg-white rounded shadow-lg z-20"
